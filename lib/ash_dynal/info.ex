defmodule AshDynal.Info do
  ...
  @doc "Returns the list of `AshDynal.Dsl.AnalyzableField` entities for a resource."
  @spec analyzable_fields(module()) :: [AnalyzableField.t()]
  def analyzable_fields(resource) do
    Spark.Dsl.Extension.get_entities(resource, [:dynal])
  end

  @doc "Returns the `AnalyzableField` for a given name and type, or `nil`."
  @spec analyzable_field(module(), atom(), AnalyzableField.t().type) :: AnalyzableField.t() | nil
