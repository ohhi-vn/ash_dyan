defmodule AshDynal.Result do
  @moduledoc """
  The chart-ready output shape returned by `AshDynal.run/1`.
  ...
  formatter helpers.
  """
  @spec format(AshDynal.Request.t(), [Ash.Resource.Record.t()]) ::
          {:ok, t()} | {:error, term()}
  def format(request, records) do
    AshDynal.Engine.Formatter.format(request, records)
  end
end
